...
## The pitch line (for the investor judges — 20%)

Keep it about the one thing we shipped, said with conviction:

- "OpenClaw went 0→100k stars in three months — people run persistent,
  self-hosted agents already, but every one is trapped in a text box."
- "**Clawed gives your agent senses** — it sees what you see, hears what you
  hear, speaks in your ear. You can put it on and talk to it today."
- "We're from **Mentra** — we build the smart-glasses OS. We made the thing we
  most wanted: our agent, on our glasses."

(Broader roadmap lives in private notes — keep the pitch and the repo focused on
the senses demo, which is live and real.)
